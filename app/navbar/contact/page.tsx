        ...
        <div className="Main-Container">
            ...
            <div className="Holder-Main-Container">
                <div className="First-Holder">
                    <p>Contact</p>
                    <p>Get In Touch</p>
                    <p>Get in touch with Eaneer for all your electrical needs. Let's spark innovation together!</p> 
                    <p>Reach out today.</p>
                </div>
            </div>
                    ...
                    <div className="Second-Holder-Content">
                        <div className="First-Content">
                            <div className="First-Content-Titles">
                                <p>Contact Us</p>
                                <p>Contact Eaneer for any inquiries, quotes, or collaboration requests. Our team is available to answer your questions and assist you with your electrical projects.</p>
                            </div>
                            <div className="First-Content-Info-Contact">
                                <div className="First-Info">
                                    <Image src={adresse_contact} alt={"Adresse_Of_Company"} height={31} width={32}></Image>
                                ...
                                <div className="Second-Info">
                                  <Image src={telephone_contact} alt={"Telephone_Number_Of_Company"} height={31} width={32}></Image>
                                ...
                                <div className="Third-Info">
                                  <Image src={email_contact} alt={"Email_Of_Company"} height={31} width={32}></Image>
